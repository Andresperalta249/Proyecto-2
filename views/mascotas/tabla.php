    ...
    <table class="tabla-app" id="tablaMascotas">
        <?php if (!empty($mascotas)): ?>
            <?php foreach ($mascotas as $mascota): ?>
                <tr>
                    <td style="width: 48px;"><?= $mascota['id_mascota'] ?></td>
                    ...
                    <td style="width: 90px;">
                        ...
                        <button class="btn-accion btn-danger btnEliminarMascota" data-id="<?= $mascota['id_mascota'] ?>" title="Eliminar" data-bs-toggle="tooltip">
